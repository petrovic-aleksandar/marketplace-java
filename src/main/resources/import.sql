...
insert into itemtype (id, name, description, imagePath) values (1, 'General', 'general stuff..', 'Categories/1.jpg');
insert into itemtype (id, name, description, imagePath) values (2, 'Cars', 'Cars, boats, trains and other transportation vehicles.', 'Categories/2.jpg');
